...
import com.mikesajak.ebooklib.search.infrastructure.adapters.outgoing.persistence.rsql.BookSearchFieldMapper
...
class SearchRepositoryAdapter(
        ...
        private val searchFieldMapper: BookSearchFieldMapper
    ...
    private fun searchEntity(query: String, pageable: Pageable): Page<BookEntity?> {
        val querySpec = rsqlParser.parseOrNull<BookEntity>(query, searchFieldMapper)
